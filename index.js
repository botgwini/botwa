...
//
const BotName = 'FastBot 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/fanbaseah'; // Nama Instagramlu cok
const whatsapplu = '+14704149067'; // Nomor whatsapplu cok
const kapanbotaktif = 'Jam 10 Off '; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/BIxGK6yMjlY0yKKaqeuot2'; // OFFICIAL GRUP LU 1
const grupch2 = 'FastBot'; // OFFICIAL GRUP LU 2
...
conn.sendMessage(id, 'Owner By Fatih wa.me/62822843844980' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah FastBot
